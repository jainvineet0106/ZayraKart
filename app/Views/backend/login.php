...
<head>
  ...
  <style>
    body, html {
      height: 100%;
      margin: 0;
      background: url('<?php echo base_url()?>public/backend/images/loginbg2.jpg') no-repeat center center fixed;
    ...
    <div class="card">
      ...
      <form action="<?php echo site_url('login');?>" method="POST">
        <div class="mb-3">
          ...
          <input name="username" type="text" class="form-control" id="email" placeholder="Enter email or username" required autofocus/>
        </div>
        <div class="mb-3">
