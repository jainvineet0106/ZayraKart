...
<body>
                    ...
                    <form method="post" id="checkoutForm">
                        ...
                        <ul class="list-group mb-3 order-summary">
                            <li class="list-group-item d-flex justify-content-between">
                                <span>Subtotal</span><strong>Rs.<span id="subtotal"><?= $subtotal; ?></span></strong>
                                <input type="hidden" name="subtotal" id="subtotalin" value="<?= $subtotal; ?>">
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                            ...
                            <li class="list-group-item d-flex justify-content-between fw-bold">
                                <span>Total</span><strong>Rs.<span id="total"><?= $subtotal + 99 + 180; ?></span></strong>
                                <input type="hidden" name="total" id="totalin" value="<?= $subtotal + 99 + 180; ?>">
                            </li>
                        </ul>
    ...
    <script>
        ...
        document.getElementById('checkoutForm').addEventListener('submit', function (e) {
            ...
            window.location.href = '<?php echo site_url('placeorder/').encode_id(session()->get('userid'));?>';
        });
    </script>
